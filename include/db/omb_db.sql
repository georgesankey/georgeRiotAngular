...
--
-- Host: localhost
-- Generation Time: Apr 29, 2016 at 05:44 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Column information for phpMyAdmin' AUTO_INCREMENT=32 ;
...
CREATE TABLE IF NOT EXISTS `pma_pdf_pages` (
  ...
  PRIMARY KEY (`page_nr`),
  KEY `db_name` (`db_name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='PDF relation pages for phpMyAdmin' AUTO_INCREMENT=4 ;
...
('root', '[{"db":"omb_db","table":"TIMESHEET"},{"db":"omb_db","table":"USER"},{"db":"omb_db","table":"USER_TOTAL_PAY"},{"db":"omb_db","table":"VENUE"},{"db":"omb_db","table":"SCRIPTS"},{"db":"omb_db","table":"EVENT"},{"db":"omb_db","table":"EVENT_ROLE_USER"},{"db":"omb_db","table":"CONTACT"},{"db":"omb_db","table":"NOTIFICATION"},{"db":"omb_db","table":"EVENT_SCRIPT"}]');
...
('root', 'omb_db', 'CONTACT', '{"CREATE_TIME":"2016-03-16 16:32:33","col_visib":["1","1","1","1","1","1","1","1"],"sorted_col":"`CONTACT`.`home_number` DESC"}', '2016-04-21 15:44:22');
