...
appModule.controller("AdminController", function ($rootScope, $scope, $http) {
 ...
 /*       $.getJSON("api/events.php?action=get_assigned_events", function( data ) {
      console.log(data);
        }); */
    ...
    var dataSourceUrl = "api/events.php?action=get_assigned_events";
    $http({
        method: 'get',
        url: dataSourceUrl
